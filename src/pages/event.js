          ...
          ? this.state.eventList.map((event) => (
              <Card variant="outlined">
                <CardContent>
                  ...
                  <Typography sx={{ textAlign:'justify', color: "text.secondary", mb: 1.5 }}>
                    {event.details}
                  </Typography>
                </CardContent>
                {/* <CardActions>
